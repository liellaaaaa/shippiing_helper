<template>
  <div class="data-center-page">
    ...
    <el-tabs v-model="activeTab" class="dc-tabs">
      <el-tab-pane label="申报要素" name="declaration">
        <DeclarationElementsTab />
      </el-tab-pane>
      <el-tab-pane label="参考文件" name="files">
        <div class="dc-layout">
          <!-- 左侧目录树面板 -->
          <div class="dc-panel">
...
import DeclarationElementsTab from './DeclarationElementsTab.vue'
...
// Lazy-load tree when switching to files tab
watch(activeTab, (tab) => {
